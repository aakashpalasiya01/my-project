          ...
          <div className="details_orow">
            ...
            <div className="details_orcol">
              <div className="details_orlabel">
                ...
                <span>
                  ${subscription?.plan?.price ? subscription?.plan?.price : "-"} / Per {subscription?.plan?.interval ? subscription.plan.interval.charAt(0).toUpperCase() + subscription.plan.interval.slice(1) : '-'}
                </span>
              </div>
            </div>
          </div>

            ...
            <div className="details_orow">
              ...
              <div className="details_orcol">
                <div className="details_orlabel">
                  ...
                  <span>{ThankyoupageApiAction?.last_invoice?.date ? moment(ThankyoupageApiAction?.last_invoice?.date * 1000).format("MMMM D, YYYY") : "-"}</span>
                </div>
              </div>
              <div className="details_orcol">
                <div className="details_orlabel">
              ...
              <div className="details_orcol">
                <div className="details_orlabel">
                  ...
                  <span>{ThankyoupageApiAction?.payment_method?.brand ? ThankyoupageApiAction.payment_method.brand.charAt(0).toUpperCase() + ThankyoupageApiAction.payment_method.brand.slice(1) : "-"}</span>
                </div>
              </div>
              <div className="details_orcol">
                <div className="details_orlabel">
              ...
              <table className="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{ThankyoupageApiAction?.payment_method?.brand ? ThankyoupageApiAction?.payment_method?.brand.charAt(0).toUpperCase() + ThankyoupageApiAction?.payment_method?.brand.slice(1) : "-"}</td>
                  </tr>
                  <tr>
                    <td>Total:</td>
                    <td>

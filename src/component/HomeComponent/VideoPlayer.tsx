...
const VideoPlayer = ({ show, handleClose, UniqueClass, VideoLoader }: any) => {
    ...
    const FormatSeconds = (duration:any) => {
        ...
        let formattedSeconds = seconds / 100;
        return formattedSeconds.toLocaleString(undefined, {minimumIntegerDigits: 2, minimumFractionDigits: 2});
    }    

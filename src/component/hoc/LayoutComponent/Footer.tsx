          ...
          <div className="row">
            ...
            <div className="col-md-6 col-lg-4 col-xl-3">
              <div className="footer_items">
                ...
                <ul>
                  ...
                  <li>
                    <Link href={ROUTES_PATH.SAFETY}>Safety</Link>
                  </li>
                  <li>
            ...
            <div className="col-md-6 col-lg-4 col-xl-3">
              <div className="footer_items">
                ...
                <ul>
                  <li>
                    <Link href={ROUTES_PATH.FAQS}>FAQs</Link>
                  </li>
                  <li>
                    <Link href={ROUTES_PATH.PRIVACYPOLICY}>Privacy policies</Link>
                  </li>
                  <li>
                    <Link href={ROUTES_PATH.TERMSANDCONDITIONS}>Terms & conditions</Link>
                  </li>
                </ul>

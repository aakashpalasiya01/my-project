...
import { LogoutPopupContent } from "@/shared/common-dialog";
  ...
  const handleLogout = async () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        Swal.fire({
          html:ReactDOMServer.renderToString(<LogoutPopupContent/>),
          icon: "success",
      }).then(() => {
          Logout();
          revalidateAllLayout();
              ...
              <>
                <ul className="navbar-nav me-auto inner_nav_left">
                  ...
                  <li>
                    <Link 
                      className={
                        pathname.includes(ROUTES_PATH.INSTRUCTORCHAT)
                          ? `active`
                          : ``
                      }
                      href={ROUTES_PATH.INSTRUCTORCHAT}
                    >
                      Instructor Chat
                    </Link>
                  </li>

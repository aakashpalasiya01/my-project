...
export const loginAction = (LoginData: FormData) => async (dispatch: AppDispatch) => {
...
export const BranchNameRegisterForm = async() =>  {
  const response = await API.get("/wp-json/wp/v2/theme-setting/branch");
  return response;
}

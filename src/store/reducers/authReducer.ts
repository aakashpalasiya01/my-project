...
export const { login, logout, refreshToken, setLoaderImage, setLoader,setSliderImage , whatWeOffer,setRegisterGroup, setCancelSubscriptionPlan, setPlanProducts, setSubscriptionPlan,setProfileUpdate } =
  authSlice.actions;
